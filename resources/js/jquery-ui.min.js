...
var clearDateInput = function(input) {
	setTimeout(function() {
		var buttonPane = $( "div.ui-datepicker div.ui-datepicker-buttonpane" );
...
$.datepicker.setDefaults({ changeYear:true, changeMonth:true, yearRange: '1970:2030', onSelect: function(){try{$(this).change();$(this).valid();}catch(e){}},
	showAnim:"show",
	duration:10,
	showButtonPanel: true,
	//beforeShow: clearDateInput,
	dateFormat: 'yy-mm-dd',
	onChangeMonthYear: function(year, month, inst) {
		clearDateInput(inst.input);
	}
});
$.datepicker._gotoToday = function(a){
	...
	var d = new Date;
	$(inst.input).val($.datepicker._formatDate(inst, d.getDate(), d.getMonth(), d.getFullYear()));
	$.datepicker._hideDatepicker();
};

var Now = new Date();
$(":text.popCalendar").datepicker();
$